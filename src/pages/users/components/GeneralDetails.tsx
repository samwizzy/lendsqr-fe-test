    ...
    <div>
      ...
      <section className="grid grid-cols-5 gap-x-6">
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">full Name</dt>
          <dd className="font-medium text-secondary">{user.profile.firstName + " " + user.profile.lastName}</dd>
          <dt className="font-light text-xs uppercase">Marital status</dt>
          <dd className="font-medium text-secondary">Single</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Phone Number</dt>
          <dd className="font-medium text-secondary">{user.phoneNumber}</dd>
          <dt className="font-light text-xs uppercase">Children</dt>
          <dd className="font-medium text-secondary">None</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Email Address</dt>
          <dd className="font-medium text-secondary">{user.email}</dd>
          <dt className="font-light text-xs uppercase">Type of residence</dt>
          <dd className="font-medium text-secondary">Parent's Apartment</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Bvn</dt>
          <dd className="font-medium text-secondary">{user.profile.bvn}</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Gender</dt>
      ...
      <section className="grid grid-cols-5 gap-x-6">
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">level of education</dt>
          <dd className="font-medium text-secondary">{user.education.level}</dd>
          <dt className="font-light text-xs uppercase">office email</dt>
          <dd className="font-medium text-secondary">{user.education.officeEmail}</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">employment status</dt>
        ...
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">sector of employment</dt>
          <dd className="font-medium text-secondary">{user.education.sector}</dd>
          <dt className="font-light text-xs uppercase">loan repayment</dt>
          <dd className="font-medium text-secondary">{user.education.loanRepayment}</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Duration of employment</dt>
      ...
      <section className="grid grid-cols-5 gap-x-6">
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Twitter</dt>
          <dd className="font-medium text-secondary">{user.socials.twitter}</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Facebook</dt>
          <dd className="font-medium text-secondary">{user.socials.facebook}</dd>
        </dl>
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Instagram</dt>
      ...
      <section className="grid grid-cols-5 gap-x-6">
        ...
        <dl className="col-span-5 sm:col-span-1">
          <dt className="font-light text-xs uppercase">Relationship</dt>
